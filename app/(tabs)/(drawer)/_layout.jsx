    ...
    <>
            ...
            <DrawerItem
              icon={({ color, size }) => (
                <Ionicons
                  name="home"
                  size={24}
                  color={pathname == "/user/home" ? "#fff" : "#6734d8"}
                />
              )}
              label={"Home"}
              labelStyle={[
              ...
              style={{
                backgroundColor: pathname == "/user/home" ? "#6734d8" : "#fff",
              }}
              onPress={() => {
            ...
            <DrawerItem
              icon={({ color, size }) => (
                <MaterialIcons
                  name="menu-book"
                  size={24}
                  color={pathname == "/note" ? "#fff" : "#6734d8"}
                />
              )}
              label={"Notes"}
              labelStyle={[
              ...
              style={{
                backgroundColor: pathname == "/note" ? "#6734d8" : "#fff",
              }}
              onPress={() => {
                router.push("/note");
              }}
            ...
            <DrawerItem
              icon={({ color, size }) => (
                <Entypo
                  name="bar-graph"
                  size={24}
                  color={pathname == "/result" ? "#fff" : "#6734d8"}
                />
              )}
              label={"Results"}
              labelStyle={[
              ...
              style={{
                backgroundColor: pathname == "/result" ? "#6734d8" : "#fff",
              }}
              onPress={() => {
                router.push("/result");
              }}
      ...
      <View className="flex-row items-center p-5 border-t-2 border-primary">
        <TouchableOpacity onPress={logout} className="flex-row items-center">
          ...
          />
          <Text className="mt-1 ml-2 text-base tracking-wide font-rmedium text-primary">
            Logout
          </Text>
        </TouchableOpacity>
      </View>
